...
--
-- Host: localhost
-- Generation Time: Sep 14, 2016 at 10:38 AM
...
(1, 'RAIMUNDO SILVA', 'M', 1, 2, '(85)3100.0000', '', '', 'RAIMUNDO.SILVA@GERADOX.COM.BR', '', '<strong>RAIMUNDO SILVA</strong><br />DIRETOR GERAL', 'A'),
(2, 'FRANCISCO SOUSA', 'M', 4, 3, '(85)0000.0000', '', '', 'FRANCISCO.SOUSA@GERADOX.COM.BR', '', 'FRANCISCO SOUSA<br />COORDENADOR FINANCEIRO', 'A'),
(3, 'ANA MARIA', 'M', 5, 4, '(85)0000.0000', '', '', 'ANA.MARIA@GERADOX.COM.BR', '', 'ANA MARIA<br />ASSEOSSORA JUR&Iacute;DICA', 'A');
...
(1, '11111111111', 'ADMINISTRADOR', 'Administrador', '21232f297a57a5a743894a0e4a801fc3', '21232f297a57a5a743894a0e4a801fc3', 1, '2', 1, 'admin@geradox.com.br', '2048'),
(2, '22222222222', 'REDATOR', NULL, 'eab9e1f8e8c7421c149be0fd8cae0114', NULL, 0, '2', 2, 'redator@geradox.com.br', '2048');
